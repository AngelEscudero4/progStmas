...
int main(int argc, char *argv[])
{
    ...
    //inicializo la pila --> llamo a la funcion crearPila para asi inicializar la cima y que luego no de un error
    PILA pila;
    crearPila(&pila);
    ...
    else if (argc == 2 && (strcmp(argv[1], "-h") == 0 || strcmp(argv[1], "--help") == 0))
    {
        ...
        // Error(EX_OK, "Uso: bocabajo [ fichero... ] \nInvierte el orden de las líneas de los ficheros (o de la entrada).\n"); //exit(0);
        exit(0);
    }
    else
    {
